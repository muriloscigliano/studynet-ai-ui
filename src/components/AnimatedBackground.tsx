...
export default function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uTime: { value: 0 },
      uColor: { value: new THREE.Color('#9B2064') }, // Your theme color
      uClickPos: { value: Array.from({ length: MAX_CLICKS }, () => new THREE.Vector2(-1, -1)) },
      uClickTimes: { value: new Float32Array(MAX_CLICKS) },
      uShapeType: { value: 0 }, // 0=square
      uPixelSize: { value: 4 },
    };
    ...
    // Fragment shader (exact from the demo)
    ...
    console.log('Bayer dithering initialized (from zavalit demo)');
